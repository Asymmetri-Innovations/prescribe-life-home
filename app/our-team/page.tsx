  ...
  return (
    <main className="space-y-32 relative pt-16 overflow-x-hidden max-w-full">
      ...
      <section className="flex flex-col items-center justify-center space-y-10 max-md:space-y-6 pt-16 max-md:pt-8 px-4 max-md:px-2 mx-5">
        <FadeRise delay={0.05}>
          <div className="text-6xl max-md:text-3xl font-bold flex justify-center items-center mb-6">
            Meet the <span className="text-theme ml-3">Team!</span>
          </div>
          <p className="text-lg max-md:text-base inter text-center">
            The experts and innovators behind PrescribeLife.ai, bringing
            together neuroscience, technology, and coaching expertise to help
            you perform better and lead with resilience.
          </p>
        </FadeRise>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-7xl w-full items-stretch">
          {teamMembers.map((member, i) => (
            <FadeRise key={i} delay={i * 0.05}>
              <MagicCard className="h-full">
                ...
                >
                  ...
                  <p className="text-base max-md:text-sm inter text-white mt-3 flex-1">
                    {member.description}
                  </p>
                </div>
              </MagicCard>
      ...
      <section className="flex flex-col items-center justify-center space-y-10 max-md:space-y-6  max-md:pt-8 px-4 max-md:px-2 mx-5">
        <FadeRise delay={0.05}>
