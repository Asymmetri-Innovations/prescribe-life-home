  ...
  return (
    ...
    >
      ...
      >
        ...
        <section className="flex flex-col gap-8 lg:gap-10 px-4">
          ...
          <div className="flex justify-center lg:justify-center items-center">
            <span className="border-1 border-white px-4 sm:px-6 py-2 rounded-3xl tracking-wide text-xs sm:text-sm lg:text-base">
              Here's what we mean
            </span>
          </div>
        </section>
      ...
      >
                ...
                <HoverGlowContainer className="rounded-2xl h-full flex flex-col">
                  <div className="">
                    <div className="flex justify-between items-start mb-4">
                      ...
                      <div className="text-3xl sm:text-4xl lg:text-5xl font-semibold text-white/30">
                        {step.id}
                      </div>
                    </div>
                    <div>
        ...
        <div className="flex gap-6 lg:gap-8 xl:gap-12 h-full items-stretch max-lg:flex-col">
          <FadeRise delay={0.2} className="w-full lg:w-1/2">
            <HoverGlowContainer className="h-full rounded-2xl flex flex-col p-4 sm:p-6 lg:p-8 shadow-lg">
            ...
            <FadeRise delay={0.2}>
              <div className="space-y-3 lg:space-y-4 relative grid grid-rows-3 gap-3 lg:gap-4 xl:gap-6">
                {[
                  ...
                  <div
                    key={idx}
                    className="flex items-start gap-3 lg:gap-4 flex-col p-4 sm:p-6 lg:p-8 rounded-3xl relative border-2 border-white/20 overflow-hidden h-full"
                  >
                    {[1, 2, 3, 4].map((x) => (
                      <div
                        key={x}
      ...
      >
        ...
        <div className="hidden lg:grid grid-cols-2 xl:grid-cols-3 gap-6 lg:gap-8">
          <div className="flex flex-col relative justify-between items-center space-y-4 lg:space-y-5">
            <div>
              <Image
                src={"/phone4.png"}
                height={50}
          ...
          <div className="flex flex-col justify-between items-center space-y-4 lg:space-y-5">
            <div>
              <Image
                src={"/phone5.png"}
                height={50}
      ...
      >
        ...
        <div className="flex items-center justify-center gap-6 lg:gap-8 xl:gap-10 max-lg:flex-col">
          ...
          <div className="flex justify-center lg:justify-center w-full lg:w-1/2 items-center overflow-hidden relative rounded-3xl p-6 sm:p-8 lg:p-12 xl:p-16 border-2 border-white/40">
      ...
      >
        <div className="py-12 lg:py-16">
          ...
          {/* Content Section */}
          <div className="grid lg:grid-cols-2 gap-6 lg:gap-8 xl:gap-12 items-center px-2 lg:px-4">
            ...
            <div className="space-y-3 lg:space-y-4 relative">
              {[
                ...
                <div
                  key={idx}
                  className="flex items-start gap-3 lg:gap-4 flex-col p-4 py-6 sm:p-6 sm:py-8 lg:p-8 lg:py-10 xl:py-12 rounded-3xl relative border-2 border-white/30 overflow-hidden"
                >
                  {[1, 2, 3, 4].map((x) => (
                    <div
                      key={x}
      ...
      >
        ...
        <div className="grid grid-cols-1 xl:grid-cols-1 gap-6 lg:gap-6 w-full">
          {steps2.map((step, i) => (
            <FadeRise key={step.id} delay={i * 0.12}>
              {i !== 0 && (
                <ChevronDown
                  className="absolute left-1/2 -translate-x-1/2 -top-6 lg:-top-8"
                  size={
                    typeof window !== "undefined" && window.innerWidth < 640
                      ? 32
                      : 40
              ...
              <HoverGlowContainer className="rounded-2xl p-4 sm:p-6 lg:p-8 border relative overflow-hidden space-y-3 sm:space-y-4 lg:space-y-6">
                <div className="absolute top-4 right-4 sm:top-6 sm:right-6 text-3xl sm:text-4xl lg:text-5xl xl:text-6xl font-bold text-white/30 opacity-50">
                  {step.id}
                </div>
                <step.icon
                  size={
        ...
        <div className="hidden lg:flex flex-row justify-center items-stretch w-full max-w-6xl divide-x divide-white/20">
          {[
            ...
            >
              ...
              <p className="text-white/60 text-center max-w-xs text-sm lg:text-base tracking-wide inter">
                {m.label}
              </p>
            </FadeRise>
          ))}
              ...
              {[
                ...
                >
                  <img
                    src={app.src}
                    alt={app.name}
                    className="w-10 h-10 sm:w-12 sm:h-12 lg:w-16 lg:h-16 rounded-full object-contain"
                  />
                  <div className="text-xs sm:text-sm lg:text-base text-white">
                    {app.name}
                  </div>
                </div>
              ))}
      ...
      >
        <Image
          ...
          height={400}
          alt="security"
          className="mx-auto w-full max-w-[250px] sm:max-w-xs lg:max-w-lg xl:max-w-2xl h-auto"
